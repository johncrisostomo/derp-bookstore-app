<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuthorDetail.aspx.cs" Inherits="AuthorDetail" %>
...
<body>
    <form id="form1" runat="server">
        <customControls:Header ID="Header1" runat="server" heading="Author Detail" />
